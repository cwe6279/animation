...
talker/
  ...
  faces/
    ...
    cat/eye/             <- live eyes: the dragon design recoloured green (cat/eye_unwrapped/ holds the
                            parts unwrapped from her original art, as an alternative)
...
python talker.py --face cat --text "Meow, I am a spooky cat"
...
python talker.py --face cat --text "[angry]I am very angry! [sad]But also sad."
python talker.py --face cat --text "Hello world" --emotion surprise
...
python talker.py --face cat --text "Quick test" --auto-exit
...
```bash
python talker.py --face cat --text "Everything is fine." --emotion angry
```
